...
//             // Determine the encoder's resolution (ticks per revolution)
//             const int encoderResolution = 2000;  // Example resolution, adjust this value

//             // Read the position in encoder ticks
//             int encoderPosition = position1;

//              // Convert encoder ticks to degrees
//             double angularPositionDegrees = (double)encoderPosition / encoderResolution * 360.0;
//             /*********************************************************************************************************/
//             measure1 = position1;
...
// }
// /***********************************************************/
// //int updatePIDGain(kp, ki, kd)
// //{
//     // Motor 1 (DCMOTOR1)
//  //   gain = setPIDgains1(kp, ki, kd);
//  //   return gain;
// //}
// /***************************************************************/
// #endif
